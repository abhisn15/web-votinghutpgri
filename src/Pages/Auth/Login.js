	...
	const handleLoginClick = async () => {
		try {
			const response = await axios.post(
				"http://192.168.1.5:8000/api/login",
				{
					username,
					password,
				},
			...
			localStorage.setItem("hasVotedTerkiller", responseData.user.hasVotedTerkiller);
			localStorage.setItem("hasVotedTerinspiratif", responseData.user.hasVotedTerkiller);
          ...
          const hasVotedStatus = responseData.user.hasVoted;
					localStorage.setItem("hasVoted", hasVotedStatus);
	...
	return (
		<section className="gradient-form h-screen flex justify-center items-center bg-neutral-200 dark:bg-neutral-700">
            ...
            <div className=" flex flex-col items-center pb-12">
              ...
              <Link className="text-blue-500 underline" to={'/registerasi'}>Registerasi</Link>
            </div>
